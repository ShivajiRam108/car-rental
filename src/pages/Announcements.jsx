    ...
    <>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Link to="/announcements/new" className="px-4 py-2 rounded bg-blue-600 text-white">Add Announcement</Link>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-200 uppercase">Title</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-200 uppercase">Priority</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-200 uppercase">Status</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-200 uppercase">Target</th>
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {rows.map(r => (
                <tr key={r.id}>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{r.priority}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{r.target}</td>
              ...
              {rows.length === 0 && (
                <tr><td className="px-6 py-8 text-sm text-gray-500 dark:text-gray-400" colSpan={5}>No announcements. Click “Add Announcement”.</td></tr>
              )}
            </tbody>
          </table>
        </div>
