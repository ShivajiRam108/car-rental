...
const AddArea = () => {
  ...
  const handleAdd = (e) => {
    ...
    if (!formData.areaName || !formData.city || !formData.state || !formData.pincode) {
      toast.error("Please fill all fields!", { position: "top-right" });
      return;
    }

    // ✅ API call will go here (for now we simulate success)
    console.log("New Area Added:", formData);

    toast.success("Area added successfully!", { position: "top-right" });
